...
def plot_profile(upper_threshold, lower_threshold, tolerance, title, df_plot, channels, tc_channel_names, gl = False):
    data_all = []

    ls_index = list(df_plot.index)
...
def plot_profile_ra(upper_threshold, lower_threshold, tolerance, rate_adjustment, title, df_plot, channels, tc_channel_names, gl = False):
    data_all = []
    ls_index = list(df_plot.index)
